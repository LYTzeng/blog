  ...
  <main class="home" aria-labelledby="main-title">
    <div class="bio" style="width: 80%; padding-left:10%; padding-right: 10%;">
      ...
      <div style="display: flex; justify-content:center; padding-top: 10px; margin: 0">
        ...
        <span>
          <a href="/feed.xml" target="_blank" rel="noopener" title="rss" type="application/rss+xml"><svg fill="#e6e6e6" focusable="false" preserveAspectRatio="xMidYMid meet" style="will-change: transform;" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" aria-hidden="true"><path d="M8 18c-3.3 0-6 2.7-6 6s2.7 6 6 6 6-2.7 6-6-2.7-6-6-6zm0 10c-2.2 0-4-1.8-4-4s1.8-4 4-4 4 1.8 4 4-1.8 4-4 4zm22-4h-2C28 13 19 4 8 4V2c12.1 0 22 9.9 22 22z"></path><path d="M22 24h-2c0-6.6-5.4-12-12-12v-2c7.7 0 14 6.3 14 14z"></path><title>Rss</title></svg></a>
        </span>
        <span>
...
.home 
  ...
  li
    ...
    box-shadow 2px 2px 16px hsl(0, 0%, 18%)
    a
      font-size 28px
